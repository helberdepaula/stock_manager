...
import { Municipios } from "@modules/municipios/entities/municipio.entity";
import { Regioes } from "@modules/regioes/entities/regioes.entity";
import {
  Column,
  Entity,
  Index,
...
export class Estados {
  ...
  @ManyToOne(() => Regioes, (regiao) => regiao.estados)
